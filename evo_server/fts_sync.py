...
_FTS_TABLES = [
    ("skills", "skills_fts", ["name", "domain", "pattern", "description"]),
    ("patterns", "patterns_fts", ["name", "domain", "description", "code_example"]),
    ("failure_patterns", "failures_fts", ["error_type", "description", "fix_suggestion", "domain"]),
]
